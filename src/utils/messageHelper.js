 ...
 * @return {*|string}
 */
let tokeFailLastTime = 0

const displayFailTypes = ['refreshTokenFail', 'loginRequired', 'deviceNotFound']
...
export const messageActionFailure = (type?: string = 'action') => {
  ...
  // if (displayFailTypes.indexOf(type) !== -1) {
  //   const now = Date.now()
  //   if (now - tokeFailLastTime < 1000) {
  //     return
  //   }
  //   tokeFailLastTime = now
  // }
