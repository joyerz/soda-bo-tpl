...
export function getTableHeader(key, tableConfig, alwayRefresh) {
  ...
  if (tableHeaderConfig && tableHeaderConfig.length !== 0) {
    let newTableHeader = []
    tableHeaderConfig.map((item, index) => {
      tableHeader.map((ele, currIndex) => {
...
export function saveTableHeader(key, tableHeader) {
 ...
 */
export function calTableWidth(tableHeader) {
  let tableWidth = 0
 ...
 */
export function dragTableHeader(key,
                                tableHeaderConfig,
                                currIndex = -1,
                                targetIndex = -1) {
 ...
 */
export function resetTableHeader(key, tableHeaderConfig) {
